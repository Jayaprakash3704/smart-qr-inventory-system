...
class _YarnDataPageState extends State<YarnDataPage> {
      ...
      if (widget.isAddMode) {
        ...
        if (widget.expectedQr != null) {
          ...
          if (!match && yarnData != null) {
            final id =
                yarnData!['id'] ?? yarnData!['yarnId'] ?? yarnData!['ID'];
            if (id != null &&
  ...
  Future<void> _fetchAutoAllocation() async {
    ...
    try {
      ...
      final allocation = await yarnService.getNextAvailableBin(
        count: 1,
  ...
  Future<void> _confirmYarn() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        debugPrint('DEBUG ERROR in _confirmYarn: $e');
      }
    } finally {
