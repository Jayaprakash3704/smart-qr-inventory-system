            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  stream: itemService.getReservedItems(),
                  builder: (context, snapshot) {
                    ...
                    if (_searchQuery.isNotEmpty) {
                      docs = docs.where((doc) {
                        ...
                        final itemId =
                        (data['id'] ?? data['itemId'] ?? data['ID'] ?? doc.id)
                            .toString()
                            .toLowerCase();
                              ...
                              confirmDismiss: (direction) async {
                                if (direction == DismissDirection.startToEnd) {
                                  await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (_) => ScanCodePage(
                                        ...
                                        title: 'Verify Move - $itemId',
                                      ),
                                    ),
                                  );
                                  
                                  // ItemDataPage handles the move confirmation
                                  return false;
                                } else {
                                  ...
                                  if (confirmRemove == true) {
                                      await itemService.deleteReservedItemById(doc.id);
                                  }
