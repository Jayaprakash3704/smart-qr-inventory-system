  ...
  return (
    <div className={`card p-5 animate-fade-in-up ${isPending ? 'border-orange-200' : ''}`}>
      ...
      <div className="space-y-1.5 mb-4">
        {(order.items || [{ yarn_type: order.yarn_type, quantity: order.quantity }]).map((item, i) => (
          <div key={i} className="flex items-center gap-2 text-xs bg-slate-50 rounded-lg px-3 py-2">
            ...
            <span className="text-slate-700 font-medium flex-1 truncate">{item.yarn_type || item.name || '—'}</span>
