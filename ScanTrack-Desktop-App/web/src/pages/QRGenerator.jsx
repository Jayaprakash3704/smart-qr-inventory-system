          ...
          {filtered.map(item => (
            <div key={item.id} className="card p-4 flex flex-col items-center text-center gap-3 animate-fade-in-up group">
              ...
              <div className="w-full">
                <p className="text-xs font-bold text-slate-700 truncate">{item.item_type || item.name || item.id}</p>
          ...
          {filtered.map(item => (
            <div key={item.id} className="flex items-center gap-4 px-5 py-3.5 hover:bg-slate-50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-slate-700 text-sm truncate">{item.item_type || item.name || item.id}</p>
