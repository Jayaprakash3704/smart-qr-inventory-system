        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="card p-6">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-slate-800">{item.item_type || item.name || id}</h2>
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <Field label="Item Type" value={item.item_type || item.name} icon={Package} />
              <Field label="Item Count / SKU" value={item.item_count || item.sku} icon={Hash} />
