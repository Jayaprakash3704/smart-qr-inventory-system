...
export default function StockOut() {
  ...
  const filtered = search
    ? inStockItems.filter(i =>
        (i.item_type || i.name || '').toLowerCase().includes(search.toLowerCase()) ||
            ...
            return (
              <div key={item.id}
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-slate-800 text-sm truncate">{item.item_type || item.name || item.id}</p>
